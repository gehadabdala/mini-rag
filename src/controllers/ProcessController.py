...
class ProcessController(BaseController):
    ...
    def __init__(self, project_id: str, db_client=None):
        super().__init__(
            project_id=project_id, db_client=db_client
        )  # Call the constructor of the BaseController with project_id

        self.project_id = project_id  # self here is propeerty
        self.project_path = ProjectController().get_project_path(project_id=project_id)

    def get_file_extention(self, file_id: str):
        return os.path.splitext(file_id)[
            -1
        ]  # بتقطع اسم الفايل واخر جزء هو ال extention
    ...
    # function to split the content of the file into chunks
    def process_file_content(
        ...
        # document has page content and metadata
