...
Revision ID: 86f0293c4e53
Revises: 
Create Date: 2026-04-23 15:26:58.614849
...
def upgrade() -> None:
    ...
    op.create_index('ix_assets_asset_project_id', 'assets', ['asset_project_id'], unique=False)
    ...
    op.create_index('ix_chunks_chunk_asset_id', 'chunks', ['chunk_asset_id'], unique=False)
    op.create_index('ix_chunks_chunk_project_id', 'chunks', ['chunk_project_id'], unique=False)
...
def downgrade() -> None:
    """Downgrade schema."""
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('ix_chunks_chunk_project_id', table_name='chunks')
    op.drop_index('ix_chunks_chunk_asset_id', table_name='chunks')
    op.drop_table('chunks')
    op.drop_index('ix_assets_asset_type', table_name='assets')
    op.drop_index('ix_assets_asset_project_id', table_name='assets')
