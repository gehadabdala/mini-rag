...
class ChunkModel(BaseDataModel):
    ...
    # bulk insert for chunks, because we will have many chunks for each file, and we want to insert them all at once for better performance
    ...
    async def get_project_chunks(
        ...
        results = (
            ...
            .skip((page_no - 1) * page_size)  # pagenation
            .limit(page_size)
            .to_list(length=None)
        )

        # result => dict must convert it into data chunk
